    ...
    <nav class="nav-main" role="navigation" aria-label="Primary">
      <div class="nav-inner">
        <a href="/" class="nav-brand" aria-label="Show Limousines — Sydney's Premier Luxury Transport — home">
          <img src="/public/assets/show-logo.svg" alt="Show Limousines" class="nav-brand__logo" width="1168" height="335">
        </a>
  ...
  return `    <footer class="foot" aria-labelledby="footHeading">
      ...
      <div class="foot__inner">
        <div class="foot__contact">
          <div>
            <div class="foot__brand"><img src="/public/assets/show-logo.svg" alt="Show Limousines" class="foot__brand-logo" width="1168" height="335"></div>
